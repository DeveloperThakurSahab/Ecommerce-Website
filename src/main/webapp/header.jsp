...
<head>
    ...
    <title>Hexashop Ecommerce Website</title>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="wishlist.jsp"><i class="fa fa-heart"></i>
                            <%
	                            try{
                            ...
                            <li class="scroll-to-section"><a href="cart.jsp"><i class="fa fa-shopping-cart"></i>
                            <%
	                            try{
